...
DIVISION_USERNAMES: Dict[str, str] = {
    ...
    "news": "KOMPAS.COM News Division",
    "video-sosmed": "Kompas.com News - Video & Social Media Department",
    "text": "Kompas.com News - Text Department",
    "kcm-sales": "Kompas.com Sales Division",
    "marcomm": "Kompas.com Marketing Division",
    "sales-ops": "Sales Operations & Programmatic Division",
    "stratman": "Strategy Management Division",
    "ga": "General Affairs Media Division",
    "vcbl": "VCBL & Pasangiklan Division",
    "intmktg": "Integrated Marketing KG Media Division",
    "marcomm-kg": "Marketing Communication KG Media Division",
    "hr-media": "Human Resources Media Division",
    "hr-media-1": "Human Resources Media 1 Division",
    "finance-2": "Finance & Accounting Media 2 Division",
    "marres": "Marketing Research Department",
    "kompasiana": "Kompasiana",
    "stratx": "StratX Division",
    "sustainability": "Sustainability - KG Media Division",
    "playz": "Playz Division",
    # legacy aliases kept for backward compatibility
    "sales": "Sales Operations & Programmatic Division",
    "lative": "Integrated Marketing KG Media Division",
    "creative": "Integrated Marketing KG Media Division",
}
