...
def render_header(
    ...
    hr_admin_name = st.session_state.get("hr_admin_name", st.session_state.get("hr_admin", ""))

    hr_admin_info = (
        f'<span class="masthead-role-badge">{hr_admin_name}</span>'
        if role_display == "HR Admin" and hr_admin_name
        else ""
    )
                ...
                <div class="masthead-brand">
                    ...
                    <div class="masthead-copy">
                        ...
                        <div class="masthead-meta">
                            ...
                            <span><span class="masthead-role-badge">{role_display}</span> {hr_admin_info}</span>
                        </div>
                    </div>
                </div>
            </div>
